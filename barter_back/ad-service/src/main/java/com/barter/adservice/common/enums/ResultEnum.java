package com.barter.adservice.common.enums;
...
public enum ResultEnum {
    ...
    public static com.barter.adservice.common.enums.ResultEnum parse(int code) {
        com.barter.adservice.common.enums.ResultEnum[] values = values();
        for (com.barter.adservice.common.enums.ResultEnum value : values) {
