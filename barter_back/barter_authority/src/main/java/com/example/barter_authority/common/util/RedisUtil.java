...
/**
 * Redis的工具类，方便Redis各种操作
 * @author walnut
 * @date 2021/11/5 7:27 下午
 * @version 1.0
 */
@Component
...
//    }
     ...
     */
     /*
      将参数ZSetOperations.TypedTuple改为了DefaultTypedTuple
      DefaultTypedTuple，它会实现 TypedTuple 接口，
      在默认的情况下 Spring 就会把带有分数的有序集合的值和分数封装到这个类中，
      这样就可以通过这个类对象读取对应的值和分数了。
     */

    public Set<DefaultTypedTuple> getZSetRank(String key, long start, long end) {
